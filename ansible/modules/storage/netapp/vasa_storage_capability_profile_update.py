...
description:
- update a storage capabilitiy profile for the netapp unified vasa appliance
...
EXAMPLES = '''
 - name: "update a storage capabilitiy profile of vasa appliance {{ inventory_hostname }}"
   local_action:
     module: vasa_storage_capability_profile_update
