...
DOCUMENTATION = '''
module: vasa_appliance_management_get_timezones

short_description: managing netapp vasa unified appliance
author: Hannes Ebelt (hannes.ebelt@sap.com)

description:
- list timezones of netapp vasa appliance
...
EXAMPLES = '''
 - name: "list timezones of vasa appliance {{ inventory_hostname }}"
   local_action:
     module: vasa_appliance_management_get_timezones
